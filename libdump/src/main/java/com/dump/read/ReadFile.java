...
public class ReadFile extends Observable {
     ...
     * @throws Exception
     */
    public List<String> readFileByLine(String fullPath, long start, long end) throws Exception {
            ...
            try {
                ...
                while (fcin.read(rBuffer) != -1) {
                    ...
                    while ((endIndex = indexOf(newStrByte, fromIndex)) != -1) {
                        ...
                        if (strArr.length > 1) {
                            String[] indexArr = strArr[1].split("\\s");
                            if (indexArr.length > 1) {
                                outStrList.add(indexArr[1].trim());
                            }
                        }
